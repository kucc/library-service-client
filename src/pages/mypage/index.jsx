...
export default function MyPage() {
  ...
  const nav = [{ navItem: "대출" }, { navItem: "예약" }, { navItem: "전체" }, { navItem: "신청" }, { navItem: "리뷰" }];
  const [selected, setSelected] = useState();
  const book = [{ img: imgbook, title: "test1", author: "cherry", publisher: "hanbit", publication_year: "2022" }, { img: imgbook, title: "test2", author: "cherry", publisher: "hanbit", publication_year: "2022" }];
  return (
    <>
      <Header />
      <div className="m-auto w-[860px]">
        ...
        <div className="mt-[70px]">
          {book.map((e, i) => <InfoCard
            key={i}
            img={e.img}
            bodyProps={e}
            footerProps={[{ text: "연장", handleClick: () => handleClick("연장") }, { text: "반납", handleClick: () => handleClick("반납") }]}
          />)}
        </div>
      </div>
    </>
