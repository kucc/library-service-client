const Notice = ({ title = "서버점검안내", date = "2023.03.12"}) => {
    ...
    return (
      <div className={`w-[349px] h-[33px] py-[7px] mb-[27px] flex text-[15px] items-center font-normal active:text-[#777777]`}>
        ...
        <>
            <button className = "flex">
                <div className = "mr-[5px]">
                    ...
                    <path d="M11.4583 19.7916V13.5416H5.20834V11.4583H11.4583V5.20825H13.5417V11.4583H19.7917V13.5416H13.5417V19.7916H11.4583Z" fill="#777777"/>
                    </g>
                    </svg>
                </div>
